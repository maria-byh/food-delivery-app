                    ...
                    <div className='relative'>
                        ...
                        {isMenu && (
                            <motion.div 
                                ...
                                {user && user.email === "maria.univ13@gmail.com" && (
                                    <Link to={'/createItem'}>
                    ...
                    {isMenu && (
                        ...
                        <ul 
                            ...
                            <li 
                                ...
                                className='text-base text-textColor  px-4 py-2 hover:bg-slate-100 duration-100 transition-all ease-in-out cursor-pointer'>
                                Home
                            </li>
                            <li 
                                onClick={() => setIsMenu(false)}
                            ...
                            <p className='m-2 p-2 rounded-md shadow-md flex items-center justify-center gap-3 cursor-pointer bg-gray-200 hover:bg-slate-300 transition-all duration-100 ease-in-out text-textColor text-base'
                                onClick={logout}>Logout <MdLogout/>
                            </p>
                        </motion.div>
                    )}   
